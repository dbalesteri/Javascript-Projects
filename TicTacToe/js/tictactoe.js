...
function placeXOrO(squareNumber) {
    //This condision ensures a square hasn't been selected already
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === "X") {
            ...
            select.style.backgroundImage = "url('images/heresjohnny2.jpg')";
        //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayer is equal to 'O', the o.png is placed in HTML.
            select.style.backgroundImage = "url('images/wendy2.jpg')"
        }
        //squareNumber and activePlayer are concatenated together and added to array.
        selectedSquares.push(squareNumber + activePlayer);
        //This calls a functin to check for any win conditions.
        checkWinConditions();
        //This condition is for changing the active player.
        if (activePlayer === "X") {
            //If active player is 'X' change it to 'O'
            activePlayer = "O";
            audio('./media/johnny2.mp3');
        //If active player is anything other than 'X'
        } else {
            //Change the activePlayer to 'X'
            activePlayer = "X";
            audio('./media/wendy.mp3');
        }
        ...
        //Returning true is needed for our computerTUrn() fucntion to work.
        return true;
    }
    ...
    function computersTurn() {
        ...
        while(!success) {
            ...
            if (placeXOrO(pickASquare)){
                ...
                //This canges our boolean and ends the loop
                success = true;
            };
        }
    }
...
function checkWinConditions() {
    ...
    // and 9 squares are selected, the code executes.
        ...
        audio('./media/thatsswell.mp3');
        //This function sets a .3 second timer befoer the resetGame is called.
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variables we plass are all included in our array true is,
        //returned an our else if condition executes the drawWinLine function.
        if(a === true && b === true && c === true) {return true;}
    }
};

//This function makes our body elemetn temporarily unclickable
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line gives us access to methods and properteis to use on canvas
    ...
    //This line indicates where the start of a lines y axis is
        ...
        function animateLineDrawing() {
            ...
            if ( x1 <= x2 && y1 <= y2) {
                ...
                if (y < y2) { y += 10; }
                //This condition cancels our animatio nloop if reach the end points
